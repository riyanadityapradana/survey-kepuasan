            ...
            <div class="card google-card mb-4">
                <div class="card-body p-4">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12"><label class="form-label">Lokasi Aduan / Layanan</label><select name="lokasi_aduan" class="form-select" required><option value="">Pilih Lokasi</option><?php foreach ($loksasiOptions as $lokasi) : ?><option value="<?= e($lokasi); ?>" <?= $lokasi === 'Lantai 1 (Rawat Jalan)' ? 'selected' : ''; ?>><?= e($lokasi); ?></option><?php endforeach; ?></select></div>
                    </div>
                </div>
            </div>
